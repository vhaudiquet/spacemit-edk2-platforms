...
STATIC SPI_FLASH_PROTOCOL  *mSpiFlashProtocol;
  ...
  )
{
  ...
  Status = mSpiFlashProtocol->UpdateWithProgress (
                                                  mSpiFlashProtocol,
                                                  (UINT32)FlashAddress,
                                                  Length,
                                                  Buffer,
  ...
  )
{
  ...
  // Locate SPI flash and SPI master protocols
  Status = gBS->LocateProtocol (
                                &gSpacemitSpiFlashProtocolGuid,
                                NULL,
                                (VOID **)&mSpiFlashProtocol
                                );
  if (EFI_ERROR (Status)) {
    DEBUG (
           (DEBUG_ERROR,
  ...
  Status = mSpiFlashProtocol->Init (mSpiFlashProtocol, TRUE);
  if (EFI_ERROR (Status)) {
