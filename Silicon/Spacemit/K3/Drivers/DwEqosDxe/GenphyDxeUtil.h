...
#ifndef __GENPHY_DXE_UTIL_H__
#define __GENPHY_DXE_UTIL_H__
...
typedef struct MII_DEV MII_DEV;

typedef EFI_STATUS (EFIAPI *MiiDevRead)(
  IN MII_DEV *Bus,
  IN INT32 Addr,
  IN INT32 Devad,
  IN INT32 Reg,
...
typedef EFI_STATUS (EFIAPI *MiiDevWrite)(
  IN MII_DEV *Bus,
  IN INT32 Addr,
  IN INT32 Devad,
  IN INT32 Reg,
...
typedef EFI_STATUS (EFIAPI *MiiDevReset)(
  IN MII_DEV *Bus
);
