...
GLOBAL_REMOVE_IF_UNREFERENCED EFI_UNICODE_STRING_TABLE
  ...
  { "eng;en", L"MMC/SD Card Host Controller" },
  { NULL,     NULL                           }
};
  ...
  )
{
  ...
  Status = EfiTestManagedDevice (
                                 ControllerHandle,
                                 gMmcDriverBinding.DriverBindingHandle,
  ...
  ControllerNameTable = mMmcControllerNameTable;
  if (ChildHandle != NULL) {
    ...
    MmcHostInstance     = MMC_HOST_INSTANCE_FROM_MMCHOST (MmcHost);
    ControllerNameTable = MmcHostInstance->ControllerNameTable;
  }
