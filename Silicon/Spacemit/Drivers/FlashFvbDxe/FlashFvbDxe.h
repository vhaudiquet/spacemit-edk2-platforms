...
#define FV_FLASH_SIGNATURE  SIGNATURE_32('v', 's', 'p', 'i')
#define INSTANCE_FROM_FVB_THIS(a)    CR(a, FV_FLASH_INSTANCE, FvbProtocol, FV_FLASH_SIGNATURE)
#define INSTANCE_FROM_BLKIO_THIS(a)  CR(a, FV_FLASH_INSTANCE, BlockIoProtocol, FV_FLASH_SIGNATURE)

typedef struct _FV_FLASH_INSTANCE FV_FLASH_INSTANCE;

typedef EFI_STATUS (*FLASH_INITIALIZE)(
