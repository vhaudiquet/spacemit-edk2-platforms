...
#ifndef __SPACEMIT_PCI_REGS_H__
#define __SPACEMIT_PCI_REGS_H__

//
// Conventional PCI and PCI-X Mode 1 devices have 256 bytes of configuration space.
// PCI-X Mode 2 and PCIe devices have 4096 bytes of configuration space.
//
...
#define PCI_BASE_ADDRESS_1              0x14      // 32 bits [header type 0,1 only]
#define PCI_BASE_ADDRESS_2              0x18      // 32 bits [header type 0 only]
...
#endif /* ifndef __SPACEMIT_PCI_REGS_H__ */
