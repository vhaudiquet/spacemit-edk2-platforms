...
#ifndef _SDRAM_SPD_DDR5_H_
#define _SDRAM_SPD_DDR5_H_
...
typedef struct {
  ...
  SPD5_SDRAM_T_STRUCT                          tCCD_M;                               ///< 94-95   SDRAM Read to Command Delay for Different Bank in Same Bank Group (tCCD_M)
  UINT8                                        tCCD_M_LowerClockLimit;               ///< 96      SDRAM Read to Command Delay for Different Bank in Same Bank Group, Lower Clock Limit
  SPD5_SDRAM_T_STRUCT                          tCCD_M_WR;                            ///< 97-98   SDRAM Write to Command Delay for Different Bank in Same Bank Group (tCCD_M_WR)
  UINT8                                        tCCD_M_WR_LowerClockLimit;            ///< 99      SDRAM Write to Command Delay for Different Bank in Same Bank Group, Lower Clock Limit
  SPD5_SDRAM_T_STRUCT                          tCCD_M_WTR;                           ///< 100-101 SDRAM Write to Read Command Delay for Same Bank Group (tCCD_M_WTR)
  UINT8                                        tCCD_M_WTR_LowerClockLimit;           ///< 102     SDRAM Write to Read Command Delay for Same Bank Group, Lower Clock Limit
  UINT8                                        Reserved2[127 - 103 + 1];             ///< 103-127 Reserved
} SPD5_BASE_SECTION;
...
typedef union {
  struct {
    UINT8    Vinbulk_Fuse :  1;                     ///< Bits 0:0
    UINT8    Vinbulk_TVS  :  1;                     ///< Bits 1:1
    UINT8    Vinmgmt_TVS  :  1;                     ///< Bits 2:2
    UINT8    Reserved     :  5;                     ///< Bits 7:3
  } Bits;
  UINT8    Data;
} SPD5_ADDITIONAL_SUPPORT_DDVICES;
...
typedef struct {
  ...
  SPD5_MODULE_DEVICE_TYPE          ThermalSensorDeviceType;     ///< 212     Thermal Sensor Device Type
  SPD5_REVISION_STRUCT             ThermalSensorRevisionNumber; ///< 213     Thermal Sensor Revision Number
  UINT8                            Reserved0[228 - 214 + 1];    ///< 214-228 Reserved
  SPD5_ADDITIONAL_SUPPORT_DDVICES  AdditionalSupportDevices;    ///< 229     Additional Support Devices
...
typedef union {
  struct {
    ...
    UINT8    IctInputClockTerminationSettings :  2;   ///< Bits 3:2
    UINT8    CHA_QCK0_B                       :  1;   ///< Bits 4:4
    UINT8    CHA_QCK1_B                       :  1;   ///< Bits 5:5
    UINT8    CHB_QCK0_B                       :  1;   ///< Bits 6:6
    UINT8    CHB_QCK1_B                       :  1;   ///< Bits 7:7
  } Bits;
  UINT8    Data;
} SPD5_CKD_CONFIGURATION;

typedef union {
  struct {
    UINT8    CHA_QCK0_A :  2;                         ///< Bits 1:0
    UINT8    CHA_QCK1_A :  2;                         ///< Bits 3:2
    UINT8    CHB_QCK0_B :  2;                         ///< Bits 5:4
    UINT8    CHB_QCK1_B :  2;                         ///< Bits 7:6
  } Bits;
  UINT8    Data;
} SPD5_CKD_QCK_DRIVER_CHARACTERISTICS;

typedef union {
  struct {
    UINT8    CHA_QCK_A :  2;                          ///< Bits 1:0
    UINT8    Reserved0 :  2;                          ///< Bits 3:2
    UINT8    CHB_QCK_B :  2;                          ///< Bits 5:4
    UINT8    Reserved1 :  2;                          ///< Bits 7:6
  } Bits;
  UINT8    Data;
} SPD5_CKD_QCK_OUTPUT_DIFFERENTIAL_SLEW_RATE;

typedef struct {
  SPD5_MANUFACTURER_ID_CODE                   ClockDriverManufacturerId;             ///< 240-241 Clock Driver Manufacturer ID Code
  SPD5_MODULE_DEVICE_TYPE                     ClockDriverDeviceType;                 ///< 242     Clock Driver Device Type
  SPD5_REVISION_STRUCT                        ClockDriverRevisionNumber;             ///< 243     Clock Driver Revision Number
  SPD5_CKD_CONFIGURATION                      CkdRw00CkdConfiguration;               ///< 244     CKD-RW00 CKD Configuration
  SPD5_CKD_QCK_DRIVER_CHARACTERISTICS         CkdRw02QckDriverCharacteristics;       ///< 245     CKD-RW02 QCK Driver Characteristics
  SPD5_CKD_QCK_OUTPUT_DIFFERENTIAL_SLEW_RATE  QckRw03QckOutputDifferentialSlewRate;  ///< 246     CKD-RW03 QCK Output Differential Slew Rate
  UINT8                                       Reserved[447 - 247 + 1];
} SPD5_MODULE_UNBUFFERED;

typedef union {
  struct {
    UINT8    QACK      : 1;                           ///< Bits 0:0
    UINT8    QBCK      : 1;                           ///< Bits 1:1
    UINT8    QCCK      : 1;                           ///< Bits 2:2
    UINT8    QDCK      : 1;                           ///< Bits 3:3
    UINT8    Reserved0 : 1;                           ///< Bits 4:4
    UINT8    BCK       : 1;                           ///< Bits 5:5
    UINT8    Reserved1 : 2;                           ///< Bits 7:6
  } Bits;
  UINT8    Data;
} SPD5_CLOCK_DRIVER_ENABLE;

typedef union {
  struct {
    UINT8    QACAOutputs          : 1;                ///< Bits 0:0
    UINT8    QBCAOutputs          : 1;                ///< Bits 1:1
    UINT8    DCS1_QxCS1           : 1;                ///< Bits 2:2
    UINT8    BCS_BCOM_BRSTOutputs : 1;                ///< Bits 3:3
    UINT8    Q_CA13Output         : 1;                ///< Bits 4:4
    UINT8    QACSOutput           : 1;                ///< Bits 5:5
    UINT8    QBCSOutput           : 1;                ///< Bits 6:6
    UINT8    Reserved0            : 1;                ///< Bits 7:7
  } Bits;
  UINT8    Data;
} SPD5_RCD_OUTPUT_ENABLE;

typedef union {
  struct {
    UINT8    QACK :  2;                               ///< Bits 1:0
    UINT8    QBCK :  2;                               ///< Bits 3:2
    UINT8    QCCK :  2;                               ///< Bits 5:4
    UINT8    QDCK :  2;                               ///< Bits 7:6
  } Bits;
  UINT8    Data;
} SPD5_RCD_QCK_DRIVER_CHARACTERISTICS;

typedef union {
  struct {
    UINT8    Address_Command :  2;                    ///< Bits 1:0
    UINT8    Reserved0       :  2;                    ///< Bits 3:2
    UINT8    QxCS0_QxCS1     :  2;                    ///< Bits 5:4
    UINT8    Reserved1       :  2;                    ///< Bits 7:6
  } Bits;
  UINT8    Data;
} SPD5_RCD_QXCA_QXCS_DRIVER_CHARACTERISTICS;

typedef union {
  struct {
    UINT8    BCOM_BCS  :  2;                          ///< Bits 1:0
    UINT8    Reserved0 :  1;                          ///< Bits 2:2
    UINT8    BCKt_BCKc :  2;                          ///< Bits 4:3
    UINT8    Reserved1 :  3;                          ///< Bits 7:5
  } Bits;
  UINT8    Data;
} SPD5_RCD_DATA_BUFFER_INTERFACE;

typedef union {
  struct {
    UINT8    QCK       :  2;                          ///< Bits 1:0
    UINT8    Q_CA      :  2;                          ///< Bits 3:2
    UINT8    Q_CS      :  2;                          ///< Bits 5:4
    UINT8    Reserved0 :  2;                          ///< Bits 7:6
  } Bits;
  UINT8    Data;
} SPD5_RCD_Q_OUTPUT_SLEW_RATE;

typedef union {
  struct {
    UINT8    BCOM_BCS  :  2;                          ///< Bits 1:0
    UINT8    BCK       :  2;                          ///< Bits 3:2
    UINT8    Reserved0 :  4;                          ///< Bits 7:4
  } Bits;
  UINT8    Data;
} SPD5_RCD_B_OUTPUT_SLEW_RATE;

typedef union {
  struct {
    UINT8    DqsRttParkTermination :  3;              ///< Bits 2:0
    UINT8    Reserved0             :  5;              ///< Bits 7:3
  } Bits;
  UINT8    Data;
} SPD5_DB_DQS_RTT_PARK_TERMINATION;

typedef struct {
  SPD5_MANUFACTURER_ID_CODE                  RegisteringClockDriverManufacturerId;            ///< 240-241 Registering Clock Driver Manufacturer ID Code
  SPD5_MODULE_DEVICE_TYPE                    RegisterDeviceType;                              ///< 242     Register Device Type
  ...
  SPD5_MODULE_DEVICE_TYPE                    DataBufferDeviceType;                            ///< 246     Data Buffer Device Type
  SPD5_REVISION_STRUCT                       DataBufferRevisionNumber;                        ///< 247     Data Buffer Revision Number
  SPD5_CLOCK_DRIVER_ENABLE                   RcdRw08ClockDriverEnable;                        ///< 248     RCD-RW08 Clock Driver Enable
  SPD5_RCD_OUTPUT_ENABLE                     RcdRw09OutputAddressAndControlEnable;            ///< 249     RCD-RW09 Output Address and Control Enable
  SPD5_RCD_QCK_DRIVER_CHARACTERISTICS        RcdRw0AQckDriverCharacteristics;                 ///< 250     RCD-RW0A QCK Driver Characteristics
  UINT8                                      Reserved0;                                       ///< 251     RCD-RW0B
  SPD5_RCD_QXCA_QXCS_DRIVER_CHARACTERISTICS  RcdRw0CQxCaAndQcsnDriverCharacteristics;         ///< 252     RCD-RW0C QxCA and QxCS_n Driver Characteristics
  SPD5_RCD_DATA_BUFFER_INTERFACE             RcdRw0DDataBufferInterfaceDriverCharacteristics; ///< 253     RCD-RW0D Data Buffer Interface Driver Characteristics
  SPD5_RCD_Q_OUTPUT_SLEW_RATE                RcdRw0EQckQcaAndQcsOutputSlewRate;               ///< 254     RCD-RW0E QCK, QCA and QCS Output Slew Rate
  SPD5_RCD_B_OUTPUT_SLEW_RATE                RcdRw0FBckBcomAndBcsOutputSlewRate;              ///< 255     RCD-RW0F BCK, BCOM, and BCS Output Slew Rate
  SPD5_DB_DQS_RTT_PARK_TERMINATION           DbRw86DqsRttParkTermination;                     ///< 256     DB-RW86 DQS RTT Park Termination
...
typedef union {
  struct {
    ...
    UINT8    QACSOutput           : 1;                ///< Bits 5:5
    UINT8    QBCSOutput           : 1;                ///< Bits 6:6
    UINT8    DCS1Input            : 1;                ///< Bits 7:7
  } Bits;
  UINT8    Data;
} SPD5_MRCD_OUTPUT_ENABLE;
...
typedef union {
  struct {
    ...
    UINT8    Reserved0       :  2;                    ///< Bits 3:2
    UINT8    QxCS0_QxCS1     :  2;                    ///< Bits 5:4
    UINT8    Q_CS1Output     :  2;                    ///< Bits 7:6
  } Bits;
  UINT8    Data;
} SPD5_MRCD_QXCA_QXCS_DRIVER_CHARACTERISTICS;

typedef union {
  struct {
    UINT8    DutyCycleAdjusterConfiguration :  1;     ///< Bits 0:0
    UINT8    Reserved0                      :  7;     ///< Bits 7:1
  } Bits;
  UINT8    Data;
} SPD5_MDB_DUTY_CYCLE_ADJUSTER_CONFIGURATION;

typedef union {
  struct {
    UINT8    DramInterfaceReceiverType :  1;          ///< Bits 0:0
    UINT8    Reserved0                 :  7;          ///< Bits 7:1
  } Bits;
  UINT8    Data;
} SPD5_MDB_DRAM_INTERFACE_RECEIVER_TYPE;
...
typedef struct {
  ...
  SPD5_MODULE_DEVICE_TYPE                     DataBufferDeviceType;                            ///< 246     Data Buffer Device Type
  SPD5_REVISION_STRUCT                        DataBufferRevisionNumber;                        ///< 247     Data Buffer Revision Number
  SPD5_CLOCK_DRIVER_ENABLE                    MrcdRw08ClockDriverEnable;                       ///< 248     MRCD-RW08 Clock Driver Enable
  SPD5_MRCD_OUTPUT_ENABLE                     MrcdRw09OutputAddressAndControlEnable;           ///< 249     MRCD-RW09 Output Address and Control Enable
  SPD5_RCD_QCK_DRIVER_CHARACTERISTICS         MrcdRw0AQckDriverCharacteristics;                ///< 250     MRCD-RW0a QCK Driver Characteristics
  UINT8                                       Reserved0;                                       ///< 251     MRCD-RW0B
  SPD5_MRCD_QXCA_QXCS_DRIVER_CHARACTERISTICS  MrcdRw0CQxCaAndQcsnDriverCharacteristics;        ///< 252     MRCD-RW0C QxCA and QxCS_n Driver Characteristics
  SPD5_RCD_DATA_BUFFER_INTERFACE              MrcdRw0DDataBufferInterfaceDriverCharacteristics;///< 253     MRCD-RW0D Data Buffer Interface Driver Characteristics
  SPD5_RCD_Q_OUTPUT_SLEW_RATE                 MrcdRw0EQckQcaAndQcsOutputSlewRate;              ///< 254     MRCD-RW0E QCK, QCA and QCS Output Slew Rate
  SPD5_RCD_B_OUTPUT_SLEW_RATE                 MrcdRw0FBckBcomAndBcsOutputSlewRate;             ///< 255     MRCD-RW0F BCK, BCOM, and BCS Output Slew Rate
  SPD5_MDB_DUTY_CYCLE_ADJUSTER_CONFIGURATION  MdbPgcRwe0DutyCycleAdjusterConfiguration;        ///< 256     MDB-PG[C]RWE0 Duty Cycle Adjuster Configuration
  SPD5_MDB_DRAM_INTERFACE_RECEIVER_TYPE       MdbPg70Rwe1DramInterfaceReceiverType;            ///< 257     MDB-PG[70]RWE1 DRAM Interface Receiver Type
  UINT8                                       Reserved[447 - 258 + 1];                         ///< 258-447 Reserved
...
typedef struct {
  ...
  SPD5_MODULE_DEVICE_TYPE   DifferentialMemoryBufferDeviceType;               ///< 242     Differential Memory Buffer Device Type
...
typedef union {
  struct {
    UINT16    CapacityTenths :  4;                    ///< Bits 3:0
    UINT16    CapacityDigits :  10;                   ///< Bits 13:4
    UINT16    CapacityBase   :  2;                    ///< Bits 15:14
  } Bits;
  UINT16    Data;
  UINT8     Data8[2];
} SPD5_MODULE_STORAGE_CAPACITY;
...
typedef struct {
  ...
  SPD5_MODULE_DEVICE_TYPE       DataBufferDeviceType;                 ///< 246     Data Buffer Device Type
  SPD5_REVISION_STRUCT          DataBufferRevisionNumber;             ///< 247     Data Buffer Revision Number
  SPD5_MODULE_STORAGE_CAPACITY  ModuleStorageCapacity;                ///< 248-249 Module Storage Capacity
  UINT8                         ProtocolProfile;                      ///< 250     Protocol Profile
  UINT8                         Reserved[447 - 251 + 1];              ///< 251-447 Reserved
} SPD5_MODULE_NVDIMM_P;

typedef struct {
  SPD5_MANUFACTURER_ID_CODE                   ClockDriver0ManufacturerId;                    ///< 240-241 Clock Driver 0 Manufacturer ID Code
  SPD5_MODULE_DEVICE_TYPE                     ClockDriver0DeviceType;                        ///< 242     Clock Driver 0 Device Type
  SPD5_REVISION_STRUCT                        ClockDriver0RevisionNumber;                    ///< 243     Clock Driver 0 Revision Number
  SPD5_MANUFACTURER_ID_CODE                   ClockDriver1ManufacturerId;                    ///< 244-245 Clock Driver 1 Manufacturer ID Code
  SPD5_MODULE_DEVICE_TYPE                     ClockDriver1DeviceType;                        ///< 246     Clock Driver 1 Device Type
  SPD5_REVISION_STRUCT                        ClockDriver1RevisionNumber;                    ///< 247     Clock Driver 1 Revision Number
  UINT8                                       Reserved0[255 - 248 + 1];                      ///< 248-255 Reserved
  SPD5_CKD_CONFIGURATION                      ClockDriver0Rw00CkdConfiguration;              ///< 256     Clock Driver 0 RW00 CKD Configuration
  SPD5_CKD_QCK_DRIVER_CHARACTERISTICS         ClockDriver0Rw02QckDriverCharacteristics;      ///< 257     Clock Driver 0 RW02 QCK Driver Characteristics
  SPD5_CKD_QCK_OUTPUT_DIFFERENTIAL_SLEW_RATE  ClockDriver0Rw03QckOutputDifferentialSlewRate; ///< 258     Clock Driver 0 RW03 QCK Output Differential Slew Rate
  SPD5_CKD_CONFIGURATION                      ClockDriver1Rw00CkdConfiguration;              ///< 259     Clock Driver 1 RW00 CKD Configuration
  SPD5_CKD_QCK_DRIVER_CHARACTERISTICS         ClockDriver1Rw02QckDriverCharacteristics;      ///< 260     Clock Driver 1 RW02 QCK Driver Characteristics
  SPD5_CKD_QCK_OUTPUT_DIFFERENTIAL_SLEW_RATE  ClockDriver1Rw03QckOutputDifferentialSlewRate; ///< 261     Clock Driver 1 RW03 QCK Output Differential Slew Rate
  UINT8                                       Reserved1[447 - 262 + 1];                      ///< 262-447 Reserved
} SPD5_MODULE_COMPRESSION_ATTACHED;

typedef union {
  SPD5_MODULE_SOLDER_DOWN           SolderDown;          ///< 240-447 Solder Down Memory Module Types
  SPD5_MODULE_UNBUFFERED            Unbuffered;          ///< 240-447 Clock or Unbuffered Memory Module Types
  SPD5_MODULE_REGISTERED            Registered;          ///< 240-447 Registered or Load Reduced Memory Module Types
  SPD5_MODULE_MULTIPLEXED_RANK      MultiplexedRank;     ///< 240-447 Mutiplexed Rank Memory Module Types
  SPD5_MODULE_DIFFERENTIAL          Differential;        ///< 240-447 Differential (DDR-D) Memory Module Types
  ...
  SPD5_MODULE_COMPRESSION_ATTACHED  CompressionAttached; ///< 240-447 Compression Attached Memory Parameters
